...
const AnimatedCart = ({img,text,details,price}) => {
    return (
        <div className='group relative h-[430px] w-[340px]'>
            ...
            <div className='w-full h-0 group-hover:h-[380px] rounded-3xl duration-200 absolute bottom-[50px] bg-black bg-opacity-60 z-10'>
    ...
    data-aos-easing="ease-in-out" data-aos="fade-right"  className='bg-[rgb(233,241,253)] shadow-2xl  duration-500 right-8 absolute bottom-20 w-full rounded-3xl p-4 m-4 '>
