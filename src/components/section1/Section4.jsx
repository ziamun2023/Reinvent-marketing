...
<div className='flex '><img className='w-10 ' src={rocket } alt="" /> <p className='text-3xl font-bold'>
    
<CountUp start={0} end={200} delay={3}> duration={14} 
  {({ countUpRef }) => (
    <div>
      <span ref={countUpRef} />
    </div>
...
<p className='ms-10' >Product Launches</p>
                ...
                <div className='my-4 lg:my-0'>
<div className='flex'><img className='w-10 ' src={mans } alt="" /> <p className='text-3xl font-bold'><CountUp  delay={3}  duration={14} start={0} end={47} >
  {({ countUpRef }) => (
    <div>
...
<p  className='ms-10'> Potential Reviewers all across India</p>
            ...
            <div className='grid lg:grid-cols-2 lg:mb-16 '>
            <div className='my-4 lg:my-0'>
<div className='flex'><img className='w-10 ' src={star } alt="" /> <p className='text-3xl font-bold'><CountUp  delay={3}  duration={14} start={0} end={3750} >
  {({ countUpRef }) => (
    <div>
      <span ref={countUpRef} /> K
    </div>
...
<p  className='ms-10'> Customer Reviews Published</p>
                ...
                <div className='my-4 lg:my-0'>
<div className='flex'><img className='w-10 ' src={percetn } alt="" /> <p className='text-3xl font-bold'><CountUp  delay={3}  duration={14} start={0} end={90} >
  {({ countUpRef }) => (
    <div>
      <span ref={countUpRef} /> %
    </div>
...
<button className=' flex  pt-1 ps-2'>Call us Now <img className='   w-8 p-1 py-auto' src={arrow} alt="" /></button ></div> </div> */}
     ...
     Schedule a Meeting
            ...
            <div data-aos="zoom-in" className='px-10 hidden lg:block'>
               ...
               <div>
<div className='flex'><img className='w-10 ' src={rocket } alt="" /> <p className='text-3xl font-bold'><CountUp  delay={3}  duration={14} start={0} end={450} >
  {({ countUpRef }) => (
    <div>
      <span ref={countUpRef} />
    </div>
