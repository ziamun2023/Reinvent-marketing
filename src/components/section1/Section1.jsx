...
const Section1 = () => {
    ...
    return (
     ...
     tracking-tight    my-component text-3xl   lg:leading-normal mx-5  mt-10'>Reach Your Target <br /> Audience </p>
        <p className='text-white mt-10 ms-5 '>Choose the right reviewers for your products, <br />  ensuring that you receive valuable feedback from <br /> your ideal customer base.</p>
...
<div  data-aos="fade-left"  className='lg:w-[380px] lg:h-[327px]  w-[336px] h-[336px]  relative  bg-gradient-to-b from-[rgb(254,102,118)] to-[rgb(237,59,74)]  rounded-2xl lg:mt-0 md:mt-0 mt-5'>
