...
const Section1 = () => {
    ...
    return (
        <div className='grid mt-20  justify-items-center lg:px-10 '>
            <p  data-aos="fade-right"  style={{fontWeight:"700"}}  className='my-component my-12 text-center  lg:text-5xl md:text-5xl text-4xl text-black'> Maximize Your Success: Explore the Benefits </p>
     ...
     tracking-tight text-medium   my-component text-3xl  duration-300 lg:mt-16 lg:pt-0 pt-24 ms-5  lg:leading-normal lg:ms-8 '>Generate More <br /> Positive     Reviews</p>
     ...
     <p className=' my-component text-white ms-5  my-3 lg:hidden md:hidden'>Attract more customers, increase conversion rates, and drive sales growth by leveraging the power of positive reviews as social proof.  </p>
     ...
     <p className=' my-component text-white px-1   text-start ps-5 lg:hidden'>     Save on advertising costs with our cost-effective solution for generating authentic reviews, enabling you to allocate your budget more efficiently.</p>
     ...
     <img className='w-[380px] h-[327px] rounded-2xl  absolute lg:top-0 top-[10px]    '  src={grid3} alt="" />
            ...
            <p style={{fontWeight:"700"}} className='text-white lg:text-4xl 
     tracking-tight    my-component text-3xl   lg:leading-normal mx-5 pt-36 lg:pt-0 md:pt-0 mt-10'>Reach Your Target <br /> Audience </p>
