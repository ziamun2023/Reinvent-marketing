...
<div className='grid justify-items-center  shadow-md shadow-gray-400 rgb(63,147,223) h-12   w-[336px] lg:w-[151px] mx-auto text-center rounded-2xl lg:rounded-3xl px-3 py-2 font-medium '>  <div>
